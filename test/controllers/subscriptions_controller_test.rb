  ...
  test 'should create subscription' do
    assert_difference('Subscription.count') do
      post subscriptions_url,
           params: { subscription: { books_id: @subscription.books_id, delete_at: @subscription.delete_at,
                                     is_active: @subscription.is_active, subscribers_id: @subscription.subscribers_id } }
    end
